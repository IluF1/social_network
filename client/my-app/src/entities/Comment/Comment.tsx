...
export const Comment = ({ userId, content, createdAt, avatar, name, login}: IComment) => {
    ...
    return (
      <div className={userId === user ? styles.userComment : styles.container}>
        ...
        <div className={styles.commentInterface}>
          <button className={styles.interfaceItemOne}><Heart/></button>
          <button className={styles.interfaceItemTwo}><MessageSquareReply/></button>
        </div>
        </div>
